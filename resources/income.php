...
<body class="bg-gradient-secondary">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-0">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mr-auto">
                    ...
                    <a class="nav-item nav-link active" data-toggle="modal" data-target="#addIncome">Add Income</a>
                </div>
    ...
    <div class="modal fade" id="addIncome" tabindex="-1" role="dialog" aria-labelledby="addIncomeCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h2 class="modal-title w-100" id="addIncomeLongTitle">Income</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="../resources/add-income.php" method="post" onsubmit="return validateAddIncome()" id="addIncomeForm">
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="number" class="form-control form-control-lg" id="amount" name="amount" placeholder="Income Amount">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="addAmount" form="addIncomeForm" class="btn btn-primary">Save</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- Retrieving results from database and display in table -->
    <div class="container p-3">
        <div class="card">
            <div class="card-header text-center">
                <h4 class="card-title w-100" id="incomeHistoryLongTitle">Income History</h4>
            </div>
            <div class="card-body">

                <?php
                $username = $_SESSION['username'];
                $result = $connection->query("SELECT * FROM income WHERE username LIKE '$username' ORDER BY date DESC")->fetchAll();
                ?>
